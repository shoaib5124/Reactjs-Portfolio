...
const About = () => {
  return (
    <section
      id="about"
      className=' mt-16 md:mt-24 lg:mt-32 font-sans'
    >
      <Container className='md:flex-row md:gap-x-10 flex flex-col-reverse gap-y-8  items-center justify-between py-10 '>

        {/* <!-- Glowing blue light --> */}
        <div class="absolute top-32 left-64 w-72 h-72 bg-[#8245ec] rounded-full blur-3xl opacity-30 animate-pulse"></div>

        {/* Left text side */}
        <div className=' w-full text-center md:text-left md:w-1/2'>
          {/* Greeting */}
          <h1 className='text-3xl sm:text-4xl  font-bold md:text-5xl lg:text-7xl mb-2'>Hi, I am</h1>
          {/* Name */}
          <h2 className='text-4xl sm:text-5xl font-bold md:text-6xl lg:text-8xl'>Shoaib Ul Hassan</h2>
          {/* Skills headig with typing effects */}
          <h3 className='text-3xl sm:text-4xl text-[#8245ec] font-bold md:text-5xl lg:text-7xl mb-2'>
         ...
         {/* Resume Button */}
          <a
            href='https://drive.google.com/file/d/1L1Lf4acNH8BIzfquiwOUReg1qnisnR7Z/view?usp=drive_link'
            target='_blank'
